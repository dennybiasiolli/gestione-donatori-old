...
#   90 giorni tra una donazione e l'altra; max. 4 volte l'anno per l'uomo,
...
def forwards_func(apps, schema_editor):
    ...
    Sesso = apps.get_model('donatori', 'Sesso')
    StatoDonatore = apps.get_model('donatori', 'StatoDonatore')
...
def reverse_func(apps, schema_editor):
    ...
    StatoDonatore.objects.using(db_alias).filter(
        utente=None, codice='Attivo').delete()
    StatoDonatore.objects.using(db_alias).filter(
        utente=None, codice='Inattivo').delete()


class Migration(migrations.Migration):

    dependencies = [
        ('donatori', '0003_donatore_sesso_statodonatore'),
    ]
